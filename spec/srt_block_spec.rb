...
describe SrtBlock do
  ...
  it "should have private methods" do
    srt.private_methods(false).sort.should == [:initialize, :time_to_float, :float_to_time].sort
  end
